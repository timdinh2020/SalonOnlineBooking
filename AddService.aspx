<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddService.aspx.cs" Inherits="TestApp.AddService" %>
...
<body>
    ...
    <div class="container">
        ...
        <br />
        <asp:Button runat="server" onclick="addService" id ="addServiceBtn" class="btn btn-primary" Text="Add Service"/>

        <asp:Button runat="server" onclick="homePageClick" id ="homePageBtn" class="btn btn-primary" Text="Home Page"/>

        <br /><br />
        <%--Label to notify of add service success--%>
